...
[X,Y] = meshgrid(x,y);
file_path = 'pp%d%d_delta=%0.5f.txt';
for j = 1:num
...
ylim([-0.003951984596475,0.037723301547717])
...
ylim([-0.0000198199123581216,0.0002221800876418784])
set(gca,'XTickLabelRotation',0);%46是字体的旋转角度
set(gca,'XTickLabelRotation',0);%46是字体的旋转角度
ax = gca();
...
set(gca,'TickDir', 'in', 'TickLength', [0.009 0.01])
% axis([0 0.00395,0 0.00025])
ylim([-0.004103677298912,0.037622053804929])
set(gca,'XTickLabelRotation',0);%46是字体的旋转角度
set(gca,'XTickLabelRotation',0);%46是字体的旋转角度
ax = gca();
ax.YRuler.Exponent = -2;
