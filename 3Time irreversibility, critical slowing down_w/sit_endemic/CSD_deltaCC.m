...
h5=figure(5)
plot(a1,data(:,2),'s-k','LineWidth',1,'markersize',10)
hold on
plot(a1,data(:,2),'k.','LineWidth',1,'markersize',10)
hold on
...
ylim([0.0001408042216956473,0.0005015375204964134])
print(h5, '-r600', '-dpdf', ['variance', num2str(1),'.pdf']);


h6=figure(6)
plot(a1,data1(:,2),'s-k','LineWidth',1,'markersize',10)
hold on
plot(a1,data1(:,2),'k.','LineWidth',1,'markersize',10)
hold on
...
% set(gca,'xtick',5:5:20)
% set(gca,'ytick',0.3:0.05:5.5)
ylim([0.071226993865031,0.106226993865031])
